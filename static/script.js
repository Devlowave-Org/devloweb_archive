...
window.addEventListener("scroll", () => {
    ...
    scrollY >= 83 && scrollY <= 800
        ...
        : scrollY >= 1100 && scrollY <= 1900
            ...
            scrollY >= 1200 && scrollY <= 1700 && document.querySelector(".second-section-1-container").querySelector(".left").querySelector("h3").classList.add("second-section-h3-animation"))
            : scrollY >= 1800 && scrollY <= 2550
                ...
                scrollY >= 2e3 && (document.querySelector(".arrow-left").classList.add("arrow-left-animation"), document.querySelector(".arrow-right").classList.add("arrow-right-animation")))
                : scrollY >= 2400 &&
                scrollY <= 2700 &&
...
console.log(message),
    form.addEventListener("submit", (e) => {
        if ((e.preventDefault(), isPass)) {
            ...
            console.log(message.value), (window.location.href = `mailto:${userEmail}?subject=${encodeURIComponent("Message provenant du site.")}&body=${encodeURIComponent(message.value)}`);
        }
        "" !== email.value &&
        ((userEmail = email.value),
            ...
            (isPass = !0),
        window.innerWidth <= 720 && ((form.style.flexDirection = "column"), (button.style.width = "100%"), (message.style.minHeight = "300px")));
    });
